...
BezierCurve.prototype.deCasteljauSplit = function(t)
{
    ...
    if (this.nodes.length == 3)
    {
        ...
        // Hint : use lerp()
        var left_temp = new Node();
        var right_temp = new Node();
        var middle = new Node();
        left_temp.lerp(this.nodes[0], this.nodes[1], t);
        right_temp.lerp(this.nodes[1], this.nodes[2], t);
        middle.lerp(left_temp, right_temp, t);

        //add the left nodes
        left.nodes[0] = this.nodes[0];
        left.nodes[1] = left_temp;
        left.nodes[2] = middle;

        //add the right nodes
        right.nodes[0] = middle;
        right.nodes[1] = right_temp;
        right.nodes[2] = this.nodes[2];
    }
    ...
    {    
        ...
        //get the Q nodes
        Q0.lerp(this.nodes[0], this.nodes[1], t);
        Q1.lerp(this.nodes[1], this.nodes[2], t);
        Q2.lerp(this.nodes[2], this.nodes[3], t);
...
BezierCurve.prototype.deCasteljauDraw = function(depth)
{
    ...
    // Else get both children by split
        ...
        var combined = this.deCasteljauSplit(this.tParameter);
